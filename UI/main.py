    ...
    if "***" in snippet:
        ...
        for current_word in words:
            if current_word.startswith("***") and current_word.endswith("***"):
                ...
                highlighted_description = highlighted_description.replace(clean_word, highlight_html)
...
def main():
    ...
    st.markdown('<div class="developer-text">Developed By: Amirhosein Rezaei</div>', unsafe_allow_html=True)
    # st.markdown('<div class="developer-text">Developed By: Amirhosein Rezaei</div>', unsafe_allow_html=True)
